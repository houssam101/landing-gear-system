...
model DriverModuleTest
  DriverModule driverModule(startL=0.5, gain=1000)
  ...
  Modelica.Mechanics.Translational.Components.Spring spring(s_rel0=0.5, c=100)
  ...
  Modelica.Blocks.Continuous.LimPID PID(controllerType=Modelica.Blocks.Types.SimpleController.P,
      k=100) annotation (Placement(transformation(extent={{-48,-10},{-28,10}})));
...
equation
  ...
  connect(positionSensor.s, PID.u_m) annotation (Line(
      points={{-11,-40},{-38,-40},{-38,-12}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(fixed.flange, spring.flange_a) annotation (Line(
      points={{94,-8},{90,-8},{90,-6.66134e-16},{70,-6.66134e-16}},
      color={0,127,0},
      smooth=Smooth.None));
